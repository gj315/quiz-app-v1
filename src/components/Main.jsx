...
class Main extends React.Component {
    ...
    render() {
        let { nr, total, question, category, answers, correct, showButton, questionAnswered, remaingAllCorrectPercentage, displayPopup, score, classNames, isAnswerCorrect,
             currentScorePercentage, remaingAllWrongPercentage, difficulty, quesPercentage } = this.state;
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-10 col-lg-offset-1">
                        ...
                        <Answers answers={answers} correct={correct} showButton={this.handleShowButton} isAnswered={questionAnswered} increaseScore={this.handleCorrectAttemp} wrongAttemp={this.handleWrongAttemp} handlePercentage={this.handlePercentage} classNames={classNames} />
